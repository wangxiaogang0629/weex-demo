...
console.log('会经过这里吗，我好像没有看到呀 晓彤')
...
function getLoaderString(type, config) {
  console.log(type, '过来做判断呢？这个type呢')
  config = config || {};
...
function loader(source) {
  ...
  console.log(output, '晓彤打印的output')
