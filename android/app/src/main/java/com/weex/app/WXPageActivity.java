...
public class WXPageActivity extends AppCompatActivity implements IWXRenderListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String jsPath = path.indexOf("/") > 0 ? path.replace("http:/", "") : path;
    String jsPath2 = jsPath.indexOf("?") > 0 ? jsPath.split("\\?data=")[0] : jsPath;
    String jsQuery = jsPath.indexOf("?") > 0 ? jsPath.split("\\?data=")[1] : "";
    ...
    mWXSDKInstance.render("WeexApp", WXFileUtils.loadAsset(jsPath2, this), options, null, -1, -1, WXRenderStrategy.APPEND_ASYNC);
  }
