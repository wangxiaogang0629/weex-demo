...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pikaday = __webpack_require__(138);
	    ...
	    var i18n = {
	      ...
	      onSelect: function onSelect(date) {
	        confirmCallback && self.sender.performCallback(confirmCallback, {
	          result: 'success',
	          data: (0, _moment2.default)(date).format('YYYY-MM-DD')
	        });
	        picker.destroy();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var modal = void 0,
	    pickerContainer = void 0,
	    pickerHeader = void 0,
	    pickerBody = void 0,
	    pickerConfirm = void 0,
	    pickerCancel = void 0,
	    pickerBar = void 0,
